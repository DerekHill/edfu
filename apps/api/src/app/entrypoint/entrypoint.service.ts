...
export class EntrypointService {
  constructor() // private readonly oxfordService: OxfordApiService,
  // private readonly entrySearchesService: BaseSearchesService,
  ...
  //     const res = await this.entrySearchesService.findOrFetch('food');
  //     console.dir(res, { depth: null });
  //     process.exit();
  //   }
